# an simple ai based calculator
# takes input as both in text and in number
#return the numerical notion asked and returns the result in num
# let us giive some assosications
#plus = +
#subract or minus = -
#multiply or times = *
